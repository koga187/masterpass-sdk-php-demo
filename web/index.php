...
<body>
				...
				<fieldset>
					...
					<table id="merchantOptions" class="ui-responsive">
						...
						<tr>
							...
							<td>
								<input type="text" name="openFeedId" id="openFeedId">
							</td>
							<td>
								Message
							</td>
							<td colspan="3">
								<textarea id="openFeedMessage" name="openFeedMessage" width="200px" style="width: 350px; height: 160px;"></textarea>
							</td>
						</tr>
					</table>
				</fieldset>
	...
	$('#iframe').click(function(event) {
		$("#merchantInfo").attr("action", "SecondOrigin.php");
		$("#merchantInfo").submit();
	});
        
        $('#initialization').click(function(event) {
		$("#merchantInfo").attr("action", "CartInitialization.php");
		$("#merchantInfo").submit();
	});
